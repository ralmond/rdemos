...
# midterm <- read.csv("https://pluto.coe.fsu.edu/rdemos/ScaleAndInstrument/Midterm-Fall2011.download.csv",
#                     header=TRUE)
...
# 
# sections <- read.table("https://pluto.coe.fsu.edu/rdemos/ScaleAndInstrument/Midterm-Fall2011.sections.txt",header=TRUE,sep="\t",row.names=1)
...
```
```{r}
midterm.pH <- colMeans(midterm.scores[midterm.HL=="H",])/midterm.points[1,]
midterm.pL <- colMeans(midterm.scores[midterm.HL=="L",])/midterm.points[1,]
